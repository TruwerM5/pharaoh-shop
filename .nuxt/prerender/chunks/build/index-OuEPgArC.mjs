...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "hero" }, _attrs))} data-v-a8e4c833><div class="hero__inner" data-v-a8e4c833>`);
      if (unref(banners)[unref(currentIndex)].id) {
        _push(`<img${ssrRenderAttr("src", `/images/${unref(banners)[unref(currentIndex)].image}`)}${ssrRenderAttr("alt", `${unref(banners)[unref(currentIndex)].id}`)} class="hero__image" data-v-a8e4c833>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="hero__content" data-v-a8e4c833><h1 class="hero__title page-title" data-v-a8e4c833>Pharaoh shop</h1></div></div></div>`);
    };
  }
});
...
const HeroVue = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-a8e4c833"]]);
...
//# sourceMappingURL=index-OuEPgArC.mjs.map
