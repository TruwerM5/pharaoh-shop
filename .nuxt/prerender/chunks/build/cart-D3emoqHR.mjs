...
import { _ as __nuxt_component_0$3 } from './ScrollVue-BlQuY-y9.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useCartStore();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "checkout" }, _attrs))} data-v-55303e0e><button class="checkout__close-btn" data-v-55303e0e><img${ssrRenderAttr("src", _imports_0$1)} alt="\u041E\u0442\u043C\u0435\u043D\u0430" data-v-55303e0e></button><div class="checkout__inner" data-v-55303e0e><form class="checkout__form form" data-v-55303e0e><div class="checkout__block" data-v-55303e0e><input type="text" name="email" id="email" class="input checkout__input" placeholder="example@mail.ru" data-v-55303e0e><span class="checkout__label" data-v-55303e0e>Email*</span></div><div class="checkout__block" data-v-55303e0e><input type="text" name="username" id="username" class="input checkout__input" data-v-55303e0e><span class="checkout__label" data-v-55303e0e>\u0418\u043C\u044F*</span></div><div class="checkout__block" data-v-55303e0e><input type="text" name="phone_number" id="phone_number" class="input checkout__input" placeholder="+7(999)-999-99-99" data-v-55303e0e><span class="checkout__label" data-v-55303e0e>\u041D\u043E\u043C\u0435\u0440 \u0442\u0435\u043B\u0435\u0444\u043E\u043D\u0430*</span></div><div class="checkout__block" data-v-55303e0e><input type="text" name="city" id="address" class="input checkout__input" data-v-55303e0e><span class="checkout__label" data-v-55303e0e>\u0413\u043E\u0440\u043E\u0434*</span></div><div class="checkout__block" data-v-55303e0e><input type="text" name="street" id="street" class="input checkout__input" data-v-55303e0e><span class="checkout__label" data-v-55303e0e>\u0423\u043B\u0438\u0446\u0430*</span></div><div class="checkout__block" data-v-55303e0e><input type="text" name="house" id="house" class="input checkout__input" data-v-55303e0e><span class="checkout__label" data-v-55303e0e>\u2116 \u0434\u043E\u043C\u0430*</span></div><div class="checkout__block" data-v-55303e0e><input type="text" name="flat" id="flat" class="input checkout__input" data-v-55303e0e><span class="checkout__label" data-v-55303e0e>\u2116 \u043A\u0432\u0430\u0440\u0442\u0438\u0440\u044B</span></div><div class="checkout__block" data-v-55303e0e><input type="text" name="comment" id="comment" class="input checkout__input" data-v-55303e0e><span class="checkout__label" data-v-55303e0e>\u041A\u043E\u043C\u043C\u0435\u043D\u0442\u0430\u0440\u0438\u0439</span></div></form><p class="checkout__text" data-v-55303e0e>* - \u043E\u0431\u044F\u0437\u0430\u0442\u0435\u043B\u044C\u043D\u043E\u0435 \u043F\u043E\u043B\u0435</p><button class="primary-button" data-v-55303e0e>\u0417\u0430\u043A\u0430\u0437\u0430\u0442\u044C</button></div></div>`);
    };
  }
});
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-55303e0e"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isClient)) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "cart page h-full" }, _attrs))} data-v-61ea4c65><h1 class="cart__title page-title" data-v-61ea4c65>\u041A\u043E\u0440\u0437\u0438\u043D\u0430 (${ssrInterpolate(unref(CartStore).getCartCount)})</h1>`);
        if (unref(CartStore).getCartCount == 0) {
          _push(ssrRenderComponent(_component_AlertVue, null, {
            message: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<span class="cart__message text-[25px] text-left" data-v-61ea4c65${_scopeId}>\u0412 \u043A\u043E\u0440\u0437\u0438\u043D\u0435 \u043D\u0435\u0442 \u0442\u043E\u0432\u0430\u0440\u043E\u0432</span>`);
              } else {
                return [
          ...
          _push(`<div class="cart__inner h-full" data-v-61ea4c65>`);
          _push(ssrRenderComponent(_component_ScrollVue, { class: "flex flex-col flex-1" }, {
            content: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="flex flex-col justify-between h-full flex-1" data-v-61ea4c65${_scopeId}>`);
                _push2(ssrRenderComponent(_component_CartListVue, {
                  "cart-list": unref(CartStore).cart
                }, null, _parent2, _scopeId));
                _push2(`<button class="cart__open-checkout primary-button" data-v-61ea4c65${_scopeId}>\u0417\u0430\u043A\u0430\u0437\u0430\u0442\u044C</button></div>`);
              } else {
                return [
...
const cart = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-61ea4c65"]]);

export { cart as default };
//# sourceMappingURL=cart-D3emoqHR.mjs.map
