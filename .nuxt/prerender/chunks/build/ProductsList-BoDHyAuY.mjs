...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "products-list" }, _attrs))} data-v-d4943e1a><ul class="products-list__inner" data-v-d4943e1a><!--[-->`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d4943e1a"]]);

export { __nuxt_component_1 as _ };
//# sourceMappingURL=ProductsList-BoDHyAuY.mjs.map
