import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, defineComponent, provide, createElementBlock, h, onUnmounted, useSSRContext, shallowReactive, Suspense, nextTick, Transition, unref, computed, resolveComponent, Fragment, mergeProps, withCtx, createTextVNode, toDisplayString as toDisplayString$1, createVNode, openBlock, createBlock, createCommentVNode, createApp, effectScope, reactive, markRaw, isRef, isReactive, toRef, toRaw, shallowRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, getCurrentScope, onScopeDispose, defineAsyncComponent, isReadonly, toRefs, Text, isShallow } from 'file:///home/kali/Documents/pharaoh_shop/frontend/node_modules/vue/index.mjs';
...
import { createError as createError$1, sanitizeStatusCode, getRequestHeader, getRequestHeaders, setCookie, getCookie, deleteCookie } from 'file:///home/kali/Documents/pharaoh_shop/frontend/node_modules/h3/dist/index.mjs';
...
import { setupDevtoolsPlugin } from 'file:///home/kali/Documents/pharaoh_shop/frontend/node_modules/vue-devtools-stub/dist/index.mjs';
import destr from 'file:///home/kali/Documents/pharaoh_shop/frontend/node_modules/destr/dist/index.mjs';
import { parse as parse$1 } from 'file:///home/kali/Documents/pharaoh_shop/frontend/node_modules/cookie-es/dist/index.mjs';
import { isEqual as isEqual$1 } from 'file:///home/kali/Documents/pharaoh_shop/frontend/node_modules/ohash/dist/index.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./about-CRwwY1Go.mjs').then((m) => m.default || m)
  },
  {
    name: "cart",
    path: "/cart",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./cart-BHW7giDE.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_category_-C7TWrUdU.mjs').then((m) => m.default || m)
  },
  {
    name: "categoriesw",
    path: "/categoriesw",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./categoriesw-DMQ7ZACF.mjs').then((m) => m.default || m)
  },
  {
    name: "HomePage",
    path: "/HomePage",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./HomePage-Bdun8DLW.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-Df0bOwMp.mjs').then((m) => m.default || m)
  },
  {
    name: "products-id",
    path: "/products/:id()",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_id_-C94oAmgW.mjs').then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  "categories-middleware": () => import('./categories.middleware-BkF6vmrq.mjs')
};
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<button${ssrRenderAttrs(mergeProps({ class: "nav-toggle-btn" }, _attrs))} data-v-55067635><!--[-->`);
      ssrRenderList(3, (span) => {
        _push(`<span class="${ssrRenderClass([`nav-toggle-btn__icon nav-toggle-btn__icon_${span}`, { "moved": __props.isOpened }])}" data-v-55067635></span>`);
      });
      _push(`<!--]--></button>`);
    };
  }
...
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-55067635"]]);
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<li${ssrRenderAttrs(mergeProps({ class: "nav-item" }, _attrs))} data-v-ec8e41e3><span class="nav-item__title" data-v-ec8e41e3>${ssrInterpolate(__props.item.title)} <img class="${ssrRenderClass(["nav-item__icon", { "rotated": unref(isSubMenuOpened) }])}"${ssrRenderAttr("src", _imports_0$2)} alt="Open" data-v-ec8e41e3></span><ul class="${ssrRenderClass(["nested-list", { "opened": unref(isSubMenuOpened) }])}" data-v-ec8e41e3><!--[-->`);
      ssrRenderList(__props.item.categories, (category) => {
        _push(`<li class="nav-item__nested-item" data-v-ec8e41e3>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              return [
                createTextVNode(toDisplayString$1(category.title), 1)
              ];
            }
          }),
          _: 2
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-ec8e41e3"]]);
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<ul${ssrRenderAttrs(mergeProps({ class: "nav-list" }, _attrs))} data-v-8de28fce><!--[-->`);
...
const NavbarListVue = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-8de28fce"]]);
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<nav${ssrRenderAttrs(mergeProps({ class: "nav" }, _attrs))} data-v-6df84d8e>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/cart",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img class="nav__cart-icon"${ssrRenderAttr("src", _imports_0$3)} alt="Корзина" data-v-6df84d8e${_scopeId}>`);
            if (unref(isClient) && unref(cartCount)) {
              _push2(`<span class="cart__quantity" data-v-6df84d8e${_scopeId}>${ssrInterpolate(unref(cartCount))}</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              ...
              }, toDisplayString$1(unref(cartCount)), 1)) : createCommentVNode("", true)
            ];
          }
        }),
        _: 1
      ...
      _push(`<div class="${ssrRenderClass(["nav__inner", { "opened": unref(NavStore).is_opened }])}" data-v-6df84d8e>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-6df84d8e"]]);
const _imports_0$1 = publicAssetsURL("/images/3.png");
const _sfc_main$4 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLink = __nuxt_component_0$1;
  const _component_NavbarVue = __nuxt_component_1;
  _push(`<header${ssrRenderAttrs(mergeProps({ class: "header" }, _attrs))} data-v-2c25011e><div class="header__inner" data-v-2c25011e><div class="header__logo-wrapper" data-v-2c25011e>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/",
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${ssrRenderAttr("src", _imports_0$1)} alt="Logo" class="header__logo-img" data-v-2c25011e${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
            src: _imports_0$1,
...
const __nuxt_component_5 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-2c25011e"]]);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CxADHbNE.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-tTV-iZIw.mjs').then((r) => r.default || r));
