...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useCartStore();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "checkout modal" }, _attrs))} data-v-14b582db><button class="checkout__close-btn modal__close-btn" data-v-14b582db><img${ssrRenderAttr("src", _imports_0$1)} alt="\u041E\u0442\u043C\u0435\u043D\u0430" data-v-14b582db></button><div class="checkout__inner" data-v-14b582db><form class="checkout__form form" data-v-14b582db><div class="checkout__block" data-v-14b582db><input type="text" name="email" id="email" class="input checkout__input" placeholder="example@mail.ru" data-v-14b582db><span class="checkout__label" data-v-14b582db>Email*</span></div><div class="checkout__block" data-v-14b582db><input type="text" name="username" id="username" class="input checkout__input" data-v-14b582db><span class="checkout__label" data-v-14b582db>\u0418\u043C\u044F*</span></div><div class="checkout__block" data-v-14b582db><input type="text" name="phone_number" id="phone_number" class="input checkout__input" placeholder="+7(999)-999-99-99" data-v-14b582db><span class="checkout__label" data-v-14b582db>\u041D\u043E\u043C\u0435\u0440 \u0442\u0435\u043B\u0435\u0444\u043E\u043D\u0430*</span></div><div class="checkout__block" data-v-14b582db><input type="text" name="city" id="address" class="input checkout__input" data-v-14b582db><span class="checkout__label" data-v-14b582db>\u0413\u043E\u0440\u043E\u0434*</span></div><div class="checkout__block" data-v-14b582db><input type="text" name="street" id="street" class="input checkout__input" data-v-14b582db><span class="checkout__label" data-v-14b582db>\u0423\u043B\u0438\u0446\u0430*</span></div><div class="checkout__block" data-v-14b582db><input type="text" name="house" id="house" class="input checkout__input" data-v-14b582db><span class="checkout__label" data-v-14b582db>\u2116 \u0434\u043E\u043C\u0430*</span></div><div class="checkout__block" data-v-14b582db><input type="text" name="flat" id="flat" class="input checkout__input" data-v-14b582db><span class="checkout__label" data-v-14b582db>\u2116 \u043A\u0432\u0430\u0440\u0442\u0438\u0440\u044B</span></div><div class="checkout__block" data-v-14b582db><input type="text" name="comment" id="comment" class="input checkout__input" data-v-14b582db><span class="checkout__label" data-v-14b582db>\u041A\u043E\u043C\u043C\u0435\u043D\u0442\u0430\u0440\u0438\u0439</span></div></form><p class="checkout__text" data-v-14b582db>* - \u043E\u0431\u044F\u0437\u0430\u0442\u0435\u043B\u044C\u043D\u043E\u0435 \u043F\u043E\u043B\u0435</p><button class="primary-button" data-v-14b582db>\u0417\u0430\u043A\u0430\u0437\u0430\u0442\u044C</button></div></div>`);
    };
  }
});
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-14b582db"]]);
...
//# sourceMappingURL=cart-DZi2KjAH.mjs.map
