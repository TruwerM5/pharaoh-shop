...
import { _ as __nuxt_component_1 } from './ProductsList-BoDHyAuY.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "filters modal" }, _attrs))} data-v-1ee238c5><div class="filters__inner" data-v-1ee238c5><div class="filters__block" data-v-1ee238c5><span class="filters__label" data-v-1ee238c5> \u041F\u043E\u043B: </span><select placeholder="\u041D\u0435 \u0432\u044B\u0431\u0440\u0430\u043D\u043E" name="gender" id="gender" class="filters__select" data-v-1ee238c5><option value="" selected placeholder="\u041D\u0435 \u0432\u044B\u0431\u0440\u0430\u043D\u043E" data-v-1ee238c5>\u041D\u0435 \u0432\u044B\u0431\u0440\u0430\u043D\u043E</option><!--[-->`);
      ssrRenderList(unref(gendersList), (gender, i) => {
        _push(`<option${ssrRenderAttr("value", gender.gender)} data-v-1ee238c5>${ssrInterpolate(gender.title)}</option>`);
      });
      _push(`<!--]--></select></div><div class="filters__block" data-v-1ee238c5><span class="filters__label" data-v-1ee238c5> \u0411\u0440\u0435\u043D\u0434: </span><select placeholder="\u041D\u0435 \u0432\u044B\u0431\u0440\u0430\u043D\u043E" name="brand" id="brand" class="filters__select" data-v-1ee238c5><option value="" selected placeholder="\u041D\u0435 \u0432\u044B\u0431\u0440\u0430\u043D\u043E" data-v-1ee238c5>\u041D\u0435 \u0432\u044B\u0431\u0440\u0430\u043D\u043E</option><!--[-->`);
      ssrRenderList(unref(brandsList), (brand, i) => {
        _push(`<option${ssrRenderAttr("value", brand)} class="capitalize" data-v-1ee238c5>${ssrInterpolate(brand.split("-").join(" "))}</option>`);
      });
      _push(`<!--]--></select></div><div class="filters__block" data-v-1ee238c5><span class="filters__label block mb-[10px]" data-v-1ee238c5> \u0426\u0435\u043D\u0430 </span><input${ssrRenderAttr("value", _ctx.filters.minPrice)} type="number" class="filters__input" placeholder="\u041E\u0442" id="min_price" name="min_price" inputmode="numeric" pattern="[0-9]*" data-v-1ee238c5><input${ssrRenderAttr("value", _ctx.filters.maxPrice)} type="number" class="filters__input" placeholder="\u0414\u043E" id="max_price" name="max_price" inputmode="numeric" pattern="[0-9]*" data-v-1ee238c5></div>`);
      ssrRenderSlot(_ctx.$slots, "button", {}, null, _push, _parent);
      _push(`</div><button class="filters__close-btn modal__close-btn" data-v-1ee238c5><img${ssrRenderAttr("src", _imports_0$1)} alt="\u0417\u0430\u043A\u0440\u044B\u0442\u044C" class="filters__close-icon modal__close-icon" data-v-1ee238c5></button></div>`);
    };
  }
});
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-1ee238c5"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(ProductsStore).isClient) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "categories page" }, _attrs))} data-v-e9e7cffc>`);
        _push(ssrRenderComponent(_component_ScrollVue, null, {
          content: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="categories__nav page-nav" data-v-e9e7cffc${_scopeId}><h1 class="categories__title page-title" data-v-e9e7cffc${_scopeId}>${ssrInterpolate(_ctx.$t(unref(route).params.category.toString()))}</h1><button class="categories__filter-btn" data-v-e9e7cffc${_scopeId}>`);
              if (unref(filtersQuantity) > 0) {
                _push2(`<span class="categories__filter-quantity" data-v-e9e7cffc${_scopeId}>${ssrInterpolate(unref(filtersQuantity))}</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="\u0424\u0438\u043B\u044C\u0442\u0440\u044B" class="categories__filter-icon" data-v-e9e7cffc${_scopeId}></button></div>`);
              if (unref(ProductsStore).currentProducts.length > 0) {
                ...
                _push2(ssrRenderComponent(_component_AlertVue, null, {
                  message: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<span class="alert-message text-[16px] test-rose-500" data-v-e9e7cffc${_scopeId2}> \u0418\u0437\u0432\u0438\u043D\u0438\u0442\u0435, \u043F\u043E \u0432\u0430\u0448\u0435\u043C\u0443 \u0437\u0430\u043F\u0440\u043E\u0441\u0443 \u043D\u0438\u0447\u0435\u0433\u043E \u043D\u0430\u0439\u0434\u0435\u043D\u043E. </span>`);
                    } else {
                      return [
              ...
              return [
                createVNode("div", { class: "categories__nav page-nav" }, [
                  createVNode("h1", { class: "categories__title page-title" }, toDisplayString(_ctx.$t(unref(route).params.category.toString())), 1),
                  createVNode("button", {
        ...
        _push(ssrRenderComponent(_component_FiltersVue, {
          ...
          button: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button class="primary-button filter-accept-btn" data-v-e9e7cffc${_scopeId}>\u041F\u0440\u0438\u043C\u0435\u043D\u0438\u0442\u044C</button><button class="filter-disable-btn secondary-btn" data-v-e9e7cffc${_scopeId}>\u0423\u0431\u0440\u0430\u0442\u044C \u0432\u0441\u0435 \u0444\u0438\u043B\u044C\u0442\u0440\u044B</button>`);
            } else {
              return [
                createVNode("button", {
...
const _category_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e9e7cffc"]]);

export { _category_ as default };
//# sourceMappingURL=_category_-C7TWrUdU.mjs.map
