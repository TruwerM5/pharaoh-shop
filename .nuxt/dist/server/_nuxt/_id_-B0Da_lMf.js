import { _ as __nuxt_component_0 } from "./AlertVue-DHCyWgva.js";
import { defineComponent, unref, mergeProps, useSSRContext, ref, withCtx, createVNode, toDisplayString } from "vue";
...
import { _ as _imports_0$2 } from "./virtual_public-BtRi2QFo.js";
import "hookable";
import "destr";
import "klona";
import "devalue";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(ImagesStore).isGalleryOpened) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "images-details" }, _attrs))} data-v-a1359e80><div class="images-details__inner snap-x snap-mandatory" data-v-a1359e80><ul class="images-details__list" style="${ssrRenderStyle({ transform: `translateX(${-unref(ImagesStore).currentIndex * 100}%)` })}" data-v-a1359e80><!--[-->`);
        ssrRenderList(_ctx.images, (image, i) => {
          _push(`<li class="images-details__item snap-center block min-h-full" data-v-a1359e80><img${ssrRenderAttr("src", `/images/${image}`)}${ssrRenderAttr("alt", `${image}`)} class="images-details__image" data-v-a1359e80></li>`);
        });
        _push(`<!--]--></ul></div><div class="images-details__buttons" data-v-a1359e80><!--[-->`);
        ssrRenderList(_ctx.images, (icon, i) => {
          _push(`<button class="${ssrRenderClass(["images-details__btn", { "active": unref(ImagesStore).currentIndex == i }])}" data-v-a1359e80><img${ssrRenderAttr("src", `/images/${icon}`)}${ssrRenderAttr("alt", `${i}`)} class="images-details__btn-icon" data-v-a1359e80></button>`);
        });
        _push(`<!--]--></div><button class="images-details__close-btn" data-v-a1359e80><img${ssrRenderAttr("src", _imports_0$2)} alt="Закрыть" class="images-details__icon" data-v-a1359e80></button></div>`);
      } else {
        _push(`<!---->`);
      }
    };
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-a1359e80"]]);
...
//# sourceMappingURL=_id_-B0Da_lMf.js.map
