import { effectScope, reactive, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, ref, watchEffect, watch, h, shallowRef, shallowReactive, isReadonly, markRaw, toRaw, isRef, isReactive, nextTick, computed, getCurrentScope, onScopeDispose, toRefs, defineComponent, provide, createElementBlock, resolveComponent, isShallow, mergeProps, useSSRContext, withCtx, createTextVNode, toDisplayString, createVNode, openBlock, createBlock, createCommentVNode, Suspense, Transition, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
import "destr";
import "devalue";
import { ssrRenderAttrs, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderAttr, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
if (!globalThis.$fetch) {
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/about-6wagw-WX.js").then((m) => m.default || m)
  },
  {
    name: "cart",
    path: "/cart",
    ...
    component: () => import("./_nuxt/cart-6VU1X8Zf.js").then((m) => m.default || m)
  },
  {
    name: "categories",
    path: "/categories",
    ...
    component: () => import("./_nuxt/categories-BaXpgHoR.js").then((m) => m.default || m),
    children: [
      {
        ...
        component: () => import("./_nuxt/_category_-0a0Wpd8M.js").then((m) => m.default || m)
      }
    ]
  },
  {
    ...
    component: () => import("./_nuxt/HomePage-DmTln3Ek.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index-CNDTHjDu.js").then((m) => m.default || m)
  },
  {
    name: "products-id",
    path: "/products/:id()",
    ...
    component: () => import("./_nuxt/_id_-DyPxzOXR.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DAIAXsYr.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CfI6IKEc.js").then((r) => r.default || r));
